...
<html lang="en">
  <head>
    ...
    <title>Forget Password | Live Chat Messenger</title>
      ...
      <div class="row">
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" method="post" novalidate >                   
            ...
            <div class="col-md-8 order-md-1">           
            <input class="btn btn-primary btn-lg" type="submit" name="submit" value="RESET">       
...
if (isset($_POST['submit'])) 
{
  ...
  if ($u_id!="" && $u_pwd!="" && $u_cpwd!="" && $u_sq!="" && $u_sqans!="" )  
    {
      $querry_get="SELECT * FROM user_login_details WHERE user_id='$u_id'";

      $data=mysqli_query($conn,$querry_get);
      ...
      if($total == 1)
      {
        ...
        $temp_sq=$result['user_sq'];
        $temp_sqans=$result['user_ans'];

        //echo "$temp_sq";
        //echo "$temp_sqans";
        if(($u_sq==$temp_sq) && ($u_sqans==$temp_sqans))
        {
          $querry="UPDATE user_login_details SET user_pwd='$u_pwd' WHERE user_id='$u_id' " ;
          $dat=mysqli_query($conn,$querry);
          ...
          {
            echo '<div class="container"><div class="col-md-8 order-md-1"><p align="center"><font color=red>Password Reset failed<br></font>';
            echo '<font color=red>Error: '. mysqli_error($conn).'</font></p></div></div>';
          }  
        }
        else
        {
          echo '<div class="container"><div class="col-md-8 order-md-1"><p align="center"><font color=red>Invalid Security Question and Answer<br></font>';
        }
      }
      else
      {
        echo '<div class="container"><div class="col-md-8 order-md-1"><p align="center"><font color=red>Invalid Username<br></font>';
      }
    }    
}
?>
